...
var massid = [75, 78, 80, 81];
/*for(let mass of massid){ // of -> käib array läbi
    console.log(kehaMassiIndeks(173, mass));
}*/
var indeksid = massid.map(function (mass) { return kehaMassiIndeks(173, mass); }); //funktsioon, millega võimalik ka leida indeksid
...
var indeksid2 = massid.map(function (mass) { return kehaMassiIndeks2(173, mass); });
